...
import { getRecetas, moverIngredienteACompra } from '../api/index.js';
                    ...
                    <div className='flex flex-col gap-3'>
                        {recetas.map((receta, index) => (
                            <div key={index} className='bg-white/50 border border-amber-100 rounded-xl p-4'>
                                ...
                                <button
                                    onClick={() => handleAbrirCocinar(receta)}
                                    className='w-full bg-green-500 text-white rounded-lg px-3 py-2 text-xs font-medium mt-2'
                                >
                                    🍳 ¡A cocinar!
                                </button>
                            </div>
